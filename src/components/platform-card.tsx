...
const iconMap = {
  ...
  tiktok: (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 2859 3333" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd">
      <path d="M2081 0c55 473 319 755 778 785v532c-266 26-499-61-770-225v995c0 1264-1378 1659-1735 747-55-142-117-414-117-692 0-225 47-512 142-738 95-225 203-348 356-429 203-110 491-110 709-110v524c-142 0-284 14-421 69-210 80-348 249-348 429 0 166 133 364 356 364 225 0 356-198 356-532v-1264c-198 122-388 284-388 473 0 110 38 217 102 312 301-166 491-491 491-893 2-414-253-747-600-917z" fill="#000000"/>
    </svg>
  ),
